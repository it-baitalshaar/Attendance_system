...
**In this repo:** The bootstrap file is **`supabase/migrations/office_schema_bootstrap_from_biotime.sql`** (same as Option A below).
...
1. **`supabase/migrations/office_schema_bootstrap_from_biotime.sql`** (in this repo)  
