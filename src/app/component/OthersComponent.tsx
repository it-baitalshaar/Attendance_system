...
interface MaintenanceDropdownProps {
  employee_id:string
  input_index:number
  atten_status:employee_status | undefined
}

const OthersComponents = ({employee_id, input_index, atten_status}:MaintenanceDropdownProps) => {
...
export default React.memo(OthersComponents);
...
// const OthersComponents = ({employee_id, input_index}:MaintenanceDropdownProps) => {
//   const [project, setProject] = useState('');
//   const [selectedHours, setSelectedHours] = useState<number | null>(null);
//   const [selectedOvertime, setSelectedOvertime] = useState<number | null>(null);
//   // const [remainingHours, setRemainingHours] = useState<number>(8);
...
//   // const [hours, setHours] = useState('');
//   const [projects, setProjects] = useState<string[]>([]);
//   let [hours, setHours] = useState<number[] | number>(Array.from({ length: 5 }, (_, i) => i));
//   let [overtime, setOvertime] = useState<number[] | number>(Array.from({ length: 5 }, (_, i) => i));
